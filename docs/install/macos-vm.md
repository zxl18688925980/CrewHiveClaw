---
summary: "Run CrewClaw in a sandboxed macOS VM (local or hosted) when you need isolation or iMessage"
read_when:
  - You want CrewClaw isolated from your main macOS environment
...
# CrewClaw on macOS VMs (Sandboxing)
...
Run CrewClaw in a sandboxed macOS VM on your existing Apple Silicon Mac using [Lume](https://cua.ai/docs/lume).
...
5. SSH in, install CrewClaw, configure channels
6. Done
...
The VM runs in the background. CrewClaw's daemon keeps the gateway running.
...
This is the killer feature of running on macOS. Use [BlueBubbles](https://bluebubbles.app) to add iMessage to CrewClaw.
