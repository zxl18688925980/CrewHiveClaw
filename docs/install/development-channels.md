...
CrewClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, CrewClaw also aligns
the install method:
...
When you switch channels with `openclaw update`, CrewClaw also syncs plugin sources:
