---
summary: "Move (migrate) a CrewClaw install from one machine to another"
read_when:
  - You are moving CrewClaw to a new laptop/server
  - You want to preserve sessions, auth, and channel logins (WhatsApp, etc.)
title: "Migration Guide"
---

# Migrating CrewClaw to a new machine

This guide migrates a CrewClaw Gateway from one machine to another **without redoing onboarding**.
...
### Step 1 — Install CrewClaw on the new machine
...
- [Where does CrewClaw store its data?](/help/faq#where-does-openclaw-store-its-data)
