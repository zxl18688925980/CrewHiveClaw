---
summary: "Uninstall CrewClaw completely (CLI, service, state, workspace)"
read_when:
  - You want to remove CrewClaw from a machine
...
```bash
rm -rf /Applications/CrewClaw.app
```
...
Default task name is `CrewClaw Gateway` (or `CrewClaw Gateway (<profile>)`).
The task script lives under your state dir.

```powershell
schtasks /Delete /F /TN "CrewClaw Gateway"
