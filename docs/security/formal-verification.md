...
summary: Machine-checked security models for CrewClaw’s highest-risk paths.
read_when:
...
This page tracks CrewClaw’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that CrewClaw enforces its
...
**What this is not (yet):** a proof that “CrewClaw is secure in all respects” or that the full TypeScript implementation is correct.
