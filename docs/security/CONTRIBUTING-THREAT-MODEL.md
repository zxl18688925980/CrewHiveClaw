# Contributing to the CrewClaw Threat Model

Thanks for helping make CrewClaw more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of CrewClaw are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [CrewClaw Threat Model](/security/THREAT-MODEL-ATLAS)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the CrewClaw security hall of fame for significant contributions.
