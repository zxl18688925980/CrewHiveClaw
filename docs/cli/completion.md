...
read_when:
  ...
  - You need to cache completion scripts under CrewClaw state
title: "completion"
---
...
- `--install` writes a small "CrewClaw Completion" block into your shell profile and points it at the cached script.
