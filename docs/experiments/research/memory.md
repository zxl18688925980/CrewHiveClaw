...
read_when:
  ...
  - Deciding: standalone CLI vs deep CrewClaw integration
...
Recommendation: **deep integration in CrewClaw**, but keep a separable core library.

### Why integrate into CrewClaw?

- CrewClaw already knows:
