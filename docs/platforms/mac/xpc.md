---
summary: "macOS IPC architecture for CrewClaw app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# CrewClaw macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → CrewClaw.app → local execution.
