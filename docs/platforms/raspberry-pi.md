---
summary: "CrewClaw on Raspberry Pi (budget self-hosted setup)"
read_when:
  - Setting up CrewClaw on a Raspberry Pi
  - Running CrewClaw on ARM devices
  - Building a cheap always-on personal AI
title: "Raspberry Pi"
---

# CrewClaw on Raspberry Pi

## Goal

Run a persistent, always-on CrewClaw Gateway on a Raspberry Pi for **~$35-80** one-time cost (no monthly fees).
...
## 9) Access the CrewClaw Dashboard
...
If this Pi is mostly running CrewClaw, add a service drop-in to reduce restart
...
If possible, keep CrewClaw state/cache on SSD-backed storage to avoid SD-card
...
Most CrewClaw features work on ARM64, but some external binaries may need ARM builds:
