---
summary: "CrewClaw on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up CrewClaw on DigitalOcean
  - Looking for cheap VPS hosting for CrewClaw
title: "DigitalOcean"
---

# CrewClaw on DigitalOcean

## Goal

Run a persistent CrewClaw Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
