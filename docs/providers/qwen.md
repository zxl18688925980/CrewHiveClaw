---
summary: "Use Qwen OAuth (free tier) in CrewClaw"
read_when:
  - You want to use Qwen with CrewClaw
...
If you already logged in with the Qwen Code CLI, CrewClaw will sync credentials
