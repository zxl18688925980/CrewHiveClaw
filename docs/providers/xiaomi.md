---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with CrewClaw"
read_when:
  - You want Xiaomi MiMo models in CrewClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). CrewClaw uses
