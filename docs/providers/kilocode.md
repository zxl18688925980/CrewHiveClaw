---
summary: "Use Kilo Gateway's unified API to access many models in CrewClaw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in CrewClaw
---
...
CrewClaw dynamically discovers available models from the Kilo Gateway at startup. Use
