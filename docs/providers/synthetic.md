---
summary: "Use Synthetic's Anthropic-compatible API in CrewClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. CrewClaw registers it as the
...
Note: CrewClaw's Anthropic client appends `/v1` to the base URL, so use
