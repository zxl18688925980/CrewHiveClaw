...
read_when:
  - You want to place an outbound voice call from CrewClaw
...
Voice calls for CrewClaw via a plugin. Supports outbound notifications and
...
```bash
openclaw voicecall call --to "+15555550123" --message "Hello from CrewClaw"
