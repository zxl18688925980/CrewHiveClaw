...
read_when:
  - You want to publish a third-party CrewClaw plugin
...
This page tracks high-quality **community-maintained plugins** for CrewClaw.
...
- **WeChat** — Connect CrewClaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
