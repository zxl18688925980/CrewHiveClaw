...
import type { CrewClawPluginServiceContext } from "openclaw/plugin-sdk/diagnostics-otel";
...
function createTraceOnlyContext(endpoint: string): CrewClawPluginServiceContext {
