import type { CrewClawConfig, CrewClawPluginApi } from "openclaw/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: CrewClawConfig): { id: string; name: string } {
