...
import { createAccountListHelpers, type CrewClawConfig } from "openclaw/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: CrewClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: CrewClawConfig): ResolvedZaloAccount[] {
