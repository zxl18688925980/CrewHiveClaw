...
import { createAccountListHelpers, type CrewClawConfig } from "openclaw/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: CrewClawConfig): ResolvedBlueBubblesAccount[] {
