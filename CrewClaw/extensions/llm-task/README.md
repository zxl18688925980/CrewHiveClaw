...
`openclaw.invoke --each`) without adding new CrewClaw code per workflow.
...
This extension depends on CrewClaw internal modules (the embedded agent runner).
It is intended to ship as a **bundled** CrewClaw extension (like `lobster`) and
