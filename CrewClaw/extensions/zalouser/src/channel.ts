...
function resolveZalouserOutboundChunkMode(cfg: CrewClawConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: CrewClawConfig, accountId?: string) {
