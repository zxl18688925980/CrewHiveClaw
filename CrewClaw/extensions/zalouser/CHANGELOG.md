...
- Version alignment with core CrewClaw release numbers.
...
- Rebuilt the plugin to use native `zca-js` integration inside CrewClaw (no external `zca` CLI runtime dependency).
