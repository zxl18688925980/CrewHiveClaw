...
import { resolveCrewClawPackageRoot, resolveCrewClawPackageRootSync } from "./openclaw-root.js";
...
export async function resolveControlUiDistIndexPath(
  ...
  const packageRoot = await resolveCrewClawPackageRoot({ argv1: normalized, moduleUrl });
  if (packageRoot) {
