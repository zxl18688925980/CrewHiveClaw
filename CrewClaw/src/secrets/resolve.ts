...
function resolveResolutionLimits(config: CrewClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: CrewClawConfig): SecretProviderConfig {
