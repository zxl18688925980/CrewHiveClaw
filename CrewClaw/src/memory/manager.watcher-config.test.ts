...
describe("memory watcher config", () => {
  ...
  function createWatcherConfig(overrides?: Partial<MemorySearchConfig>): CrewClawConfig {
    const defaults: NonNullable<NonNullable<CrewClawConfig["agents"]>["defaults"]> = {
  ...
  async function expectWatcherManager(cfg: CrewClawConfig) {
