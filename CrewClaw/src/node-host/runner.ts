...
import { loadConfig, type CrewClawConfig } from "../config/config.js";
...
import { ensureCrewClawCliOnPath } from "../infra/path-env.js";
...
function ensureNodePathEnv(): string {
  ensureCrewClawCliOnPath({ pathEnv: process.env.PATH ?? "" });
...
function buildNodeHostLocalAuthConfig(config: CrewClawConfig): CrewClawConfig {
