...
const defaultTools = createCrewClawCodingTools({ senderIsOwner: true });
...
describe("createCrewClawCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: CrewClawConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createCrewClawCodingTools({
    ...
    const anthropicTools = createCrewClawCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: CrewClawConfig = {
      tools: {
        exec: {
    ...
    const allowed = createCrewClawCodingTools({
    ...
    const denied = createCrewClawCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createCrewClawCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
