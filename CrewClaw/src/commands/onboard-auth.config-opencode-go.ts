...
export function applyOpencodeGoProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyOpencodeGoConfig(cfg: CrewClawConfig): CrewClawConfig {
