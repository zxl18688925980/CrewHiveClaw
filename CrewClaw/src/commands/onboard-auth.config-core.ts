...
export function applyOpenrouterProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: CrewClawConfig): CrewClawConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyMoonshotConfig(cfg: CrewClawConfig): CrewClawConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: CrewClawConfig): CrewClawConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: CrewClawConfig): CrewClawConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: CrewClawConfig): CrewClawConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: CrewClawConfig): CrewClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: CrewClawConfig): CrewClawConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: CrewClawConfig): CrewClawConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: CrewClawConfig): CrewClawConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: CrewClawConfig): CrewClawConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: CrewClawConfig): CrewClawConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyQianfanProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyModelStudioProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_GLOBAL_BASE_URL);
}

export function applyModelStudioProviderConfigCn(cfg: CrewClawConfig): CrewClawConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_CN_BASE_URL);
}

export function applyModelStudioConfig(cfg: CrewClawConfig): CrewClawConfig {
  const next = applyModelStudioProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MODELSTUDIO_DEFAULT_MODEL_REF);
}

export function applyModelStudioConfigCn(cfg: CrewClawConfig): CrewClawConfig {
