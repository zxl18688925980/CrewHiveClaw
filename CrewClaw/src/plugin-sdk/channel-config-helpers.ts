...
export function createScopedAccountConfigAccessors<ResolvedAccount>(params: {
  resolveAccount: (params: { cfg: CrewClawConfig; accountId?: string | null }) => ResolvedAccount;
...
> {
  const base = {
    resolveAllowFrom: ({ cfg, accountId }: { cfg: CrewClawConfig; accountId?: string | null }) =>
...
export function createScopedChannelConfigBase<
  ResolvedAccount,
  Config extends CrewClawConfig = CrewClawConfig,
>(params: {
  sectionKey: string;
