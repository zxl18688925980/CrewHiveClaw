...
function buildHooksReport(config: CrewClawConfig): HookStatusReport {
...
function enableInternalHookEntries(config: CrewClawConfig, hookNames: string[]): CrewClawConfig {
