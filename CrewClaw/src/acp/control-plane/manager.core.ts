...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: CrewClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: CrewClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: CrewClawConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: CrewClawConfig }): Promise<void> {
