...
export function listChannelMessageActions(cfg: CrewClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: CrewClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: CrewClawConfig): boolean {
