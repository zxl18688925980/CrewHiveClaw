...
function resolveAcpStreamCoalesceIdleMs(cfg: CrewClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: CrewClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: CrewClawConfig): AcpProjectionSettings {
