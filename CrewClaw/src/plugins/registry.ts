...
import type {
  CrewClawPluginApi,
  CrewClawPluginChannelRegistration,
  CrewClawPluginCliRegistrar,
  CrewClawPluginCommandDefinition,
  CrewClawPluginHttpRouteAuth,
  CrewClawPluginHttpRouteMatch,
  CrewClawPluginHttpRouteHandler,
  CrewClawPluginHttpRouteParams,
  CrewClawPluginHookOptions,
  ProviderPlugin,
  CrewClawPluginService,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: CrewClawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: CrewClawPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: CrewClawPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: CrewClawPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: CrewClawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: CrewClawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: CrewClawPluginHookOptions | undefined,
    config: CrewClawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: CrewClawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: CrewClawPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as CrewClawPluginChannelRegistration).plugin === "object"
        ? (registration as CrewClawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: CrewClawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: CrewClawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: CrewClawPluginCommandDefinition) => {
