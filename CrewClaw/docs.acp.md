...
This document describes how the CrewClaw ACP (Agent Client Protocol) bridge works,
...
CrewClaw Gateway over WebSocket. It keeps ACP session ids mapped to Gateway
...
runtime. It is designed to route IDE prompts into an existing CrewClaw Gateway
...
drive a CrewClaw Gateway session.
