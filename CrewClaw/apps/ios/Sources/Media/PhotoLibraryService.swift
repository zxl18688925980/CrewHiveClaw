...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: CrewClawPhotosLatestParams) async throws -> CrewClawPhotosLatestPayload {
        ...
        var results: [CrewClawPhotoPayload] = []
        ...
        return CrewClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> CrewClawPhotoPayload
    {
