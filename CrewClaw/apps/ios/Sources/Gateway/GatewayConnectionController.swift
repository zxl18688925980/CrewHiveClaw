...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [CrewClawCapability.canvas.rawValue, CrewClawCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(CrewClawCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(CrewClawCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = CrewClawLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(CrewClawCapability.location.rawValue) }

        caps.append(CrewClawCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(CrewClawCapability.watch.rawValue)
        }
        caps.append(CrewClawCapability.photos.rawValue)
        caps.append(CrewClawCapability.contacts.rawValue)
        caps.append(CrewClawCapability.calendar.rawValue)
        caps.append(CrewClawCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(CrewClawCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            CrewClawScreenCommand.record.rawValue,
            CrewClawSystemCommand.notify.rawValue,
            CrewClawChatCommand.push.rawValue,
        ...
        if caps.contains(CrewClawCapability.camera.rawValue) {
        ...
        if caps.contains(CrewClawCapability.location.rawValue) {
            commands.append(CrewClawLocationCommand.get.rawValue)
        }
        if caps.contains(CrewClawCapability.device.rawValue) {
            commands.append(CrewClawDeviceCommand.status.rawValue)
            commands.append(CrewClawDeviceCommand.info.rawValue)
        }
        if caps.contains(CrewClawCapability.watch.rawValue) {
            commands.append(CrewClawWatchCommand.status.rawValue)
            commands.append(CrewClawWatchCommand.notify.rawValue)
        }
        if caps.contains(CrewClawCapability.photos.rawValue) {
            commands.append(CrewClawPhotosCommand.latest.rawValue)
        }
        if caps.contains(CrewClawCapability.contacts.rawValue) {
            commands.append(CrewClawContactsCommand.search.rawValue)
            commands.append(CrewClawContactsCommand.add.rawValue)
        }
        if caps.contains(CrewClawCapability.calendar.rawValue) {
            commands.append(CrewClawCalendarCommand.events.rawValue)
            commands.append(CrewClawCalendarCommand.add.rawValue)
        }
        if caps.contains(CrewClawCapability.reminders.rawValue) {
            commands.append(CrewClawRemindersCommand.list.rawValue)
            commands.append(CrewClawRemindersCommand.add.rawValue)
        }
        if caps.contains(CrewClawCapability.motion.rawValue) {
            commands.append(CrewClawMotionCommand.activity.rawValue)
            commands.append(CrewClawMotionCommand.pedometer.rawValue)
        }
