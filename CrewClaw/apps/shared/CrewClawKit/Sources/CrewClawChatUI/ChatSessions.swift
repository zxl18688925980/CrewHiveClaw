...
public struct CrewClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct CrewClawChatSessionsDefaults: Codable, Sendable {
...
public struct CrewClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct CrewClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: CrewClawChatSessionsDefaults?
    public let sessions: [CrewClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [CrewClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
