...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: CrewClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": CrewClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": CrewClawProtocol.AnyCodable(publicKey),
            "signature": CrewClawProtocol.AnyCodable(signature),
            "signedAt": CrewClawProtocol.AnyCodable(signedAtMs),
            "nonce": CrewClawProtocol.AnyCodable(nonce),
        ]
    }
}
