import Darwin
import Testing
@testable import CrewClawDiscovery
    ...
    @Test func `discovers beacon from tailnet dns sd fallback`() {
        ...
        let context = WideAreaGatewayDiscovery.DiscoveryContext(
            ...
            dig: { args, _ in
                ...
                if recordType == "TXT" {
                    return "\"displayName=Peter\\226\\128\\153s Mac Studio (CrewClaw)\" \"gatewayPort=18789\" \"tailnetDns=peters-mac-studio-1.sheep-coho.ts.net\" \"cliPath=/Users/steipete/openclaw/src/entry.ts\""
                }
                return ""
            })
        ...
        let expectedDisplay = "Peter\u{2019}s Mac Studio (CrewClaw)"
