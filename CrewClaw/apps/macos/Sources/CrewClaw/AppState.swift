...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = CrewClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = CrewClawConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: CrewClawConfigFile.loadDict(),
        ...
        CrewClawConfigFile.saveDict(synced.root)
    }
