...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: CrewClawPeekabooBridgeServices?
    ...
    private static var openclawSocketPath: String {
        ...
        return Self.makeSocketPath(for: "CrewClaw", in: base)
    }
    ...
    private func startIfNeeded() async {
        ...
        let services = CrewClawPeekabooBridgeServices()
...
@MainActor
private final class CrewClawPeekabooBridgeServices: PeekabooBridgeServiceProviding {
