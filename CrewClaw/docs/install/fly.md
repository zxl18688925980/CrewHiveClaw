---
title: Fly.io
description: Deploy CrewClaw on Fly.io
summary: "Step-by-step Fly.io deployment for CrewClaw with persistent storage and HTTPS"
read_when:
  - Deploying CrewClaw on Fly.io
  - Setting up Fly volumes, secrets, and first-run config
---

# Fly.io Deployment

**Goal:** CrewClaw Gateway running on a [Fly.io](https://fly.io) machine with persistent storage, automatic HTTPS, and Discord/channel access.
