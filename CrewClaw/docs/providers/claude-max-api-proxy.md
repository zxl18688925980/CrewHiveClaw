...
You can point CrewClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or CrewClaw
...
- [Anthropic provider](/providers/anthropic) - Native CrewClaw integration with Claude setup-token or API keys
