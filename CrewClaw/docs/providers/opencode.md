---
summary: "Use OpenCode Zen and Go catalogs with CrewClaw"
read_when:
...
OpenCode exposes two hosted catalogs in CrewClaw:

- `opencode/...` for the **Zen** catalog
- `opencode-go/...` for the **Go** catalog

Both catalogs use the same OpenCode API key. CrewClaw keeps the runtime provider ids
