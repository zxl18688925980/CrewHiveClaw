...
This guide summarizes a sane workflow for working on the pi integration in CrewClaw.
...
State lives under the CrewClaw state directory. Default is `~/.openclaw`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.
