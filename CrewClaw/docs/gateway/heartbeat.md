...
- During heartbeat runs, CrewClaw treats `HEARTBEAT_OK` as an ack when it appears
...
If **all three** are false, CrewClaw skips the heartbeat run entirely (no model call).
