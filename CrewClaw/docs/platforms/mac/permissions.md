...
- Same path: run the app from a fixed location (for CrewClaw, `dist/CrewClaw.app`).
...
Workaround: move files into the CrewClaw workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.
