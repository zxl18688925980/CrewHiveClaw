---
summary: "CrewClaw macOS release checklist (Sparkle feed, packaging, signing)"
read_when:
  - Cutting or validating a CrewClaw macOS release
  - Updating the Sparkle appcast or feed assets
title: "macOS Release"
---

# CrewClaw macOS release (Sparkle)
...
ditto -c -k --sequesterRsrc --keepParent dist/CrewClaw.app dist/CrewClaw-2026.3.13.zip

# Optional: build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/CrewClaw.app dist/CrewClaw-2026.3.13.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/CrewClaw.app.dSYM dist/CrewClaw-2026.3.13.dSYM.zip
```
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/CrewClaw-2026.3.13.zip https://raw.githubusercontent.com/openclaw/openclaw/main/appcast.xml
```
...
- Upload `CrewClaw-2026.3.13.zip` (and `CrewClaw-2026.3.13.dSYM.zip`) to the GitHub release for tag `v2026.3.13`.
