...
public enum CrewClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct CrewClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct CrewClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
