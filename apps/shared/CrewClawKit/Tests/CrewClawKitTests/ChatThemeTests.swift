...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = CrewClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = CrewClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
