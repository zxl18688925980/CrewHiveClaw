---
summary: "Use Mistral models and Voxtral transcription with CrewClaw"
read_when:
  - You want to use Mistral models in CrewClaw
...
CrewClaw supports Mistral for both text/image model routing (`mistral/...`) and
