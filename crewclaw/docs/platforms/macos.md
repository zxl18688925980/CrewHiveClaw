---
summary: "CrewClaw macOS companion app (menu bar + gateway broker)"
read_when:
...
# CrewClaw macOS Companion (menu bar + gateway broker)

The macOS app is the **menu‑bar companion** for CrewClaw. It owns permissions,
...
1. Install and launch **CrewClaw.app**.
...
Avoid putting your CrewClaw state dir in iCloud or other cloud-synced folders.
