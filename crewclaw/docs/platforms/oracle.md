---
summary: "CrewClaw on Oracle Cloud (Always Free ARM)"
read_when:
  - Setting up CrewClaw on Oracle Cloud
  - Looking for low-cost VPS hosting for CrewClaw
  - Want 24/7 CrewClaw on a small server
title: "Oracle Cloud"
---

# CrewClaw on Oracle Cloud (OCI)

## Goal

Run a persistent CrewClaw Gateway on Oracle Cloud's **Always Free** ARM tier.

Oracle’s free tier can be a great fit for CrewClaw (especially if you already have an OCI account), but it comes with tradeoffs:
