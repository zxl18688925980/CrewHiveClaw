---
summary: "Overview of CrewClaw onboarding options and flows"
read_when:
...
CrewClaw supports multiple onboarding paths depending on where the Gateway runs
...
Use the CrewClaw app when you want a fully guided setup on macOS. Docs:
