---
summary: "Backstory and lore of CrewClaw for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "CrewClaw Lore"
---

# The Lore of CrewClaw 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **CrewClaw**.
...
In the end, **CrewClaw** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around CrewClaw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then CrewClaw): _happily runs `find ~` and shares entire directory structure in group chat_
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at CrewClaw" to promote pump-and-dump tokens.
...
**The Great CrewClaw Migration** began.
