---
summary: "Run CrewClaw Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want CrewClaw running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running CrewClaw in Docker on Hetzner or a similar provider
title: "Hetzner"
---

# CrewClaw on Hetzner (Docker, Production VPS Guide)

## Goal

Run a persistent CrewClaw Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want “CrewClaw 24/7 for ~$5”, this is the simplest reliable setup.
...
## 3) Clone the CrewClaw repository
