---
summary: "Shared Docker VM runtime steps for long-lived CrewClaw Gateway hosts"
read_when:
  - You are deploying CrewClaw on a cloud VM with Docker
...
CrewClaw runs in Docker, but Docker is not the source of truth.
