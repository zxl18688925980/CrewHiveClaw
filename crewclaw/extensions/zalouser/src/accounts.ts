...
import { createAccountListHelpers, type CrewClawConfig } from "openclaw/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: CrewClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: CrewClawConfig; accountId?: string | null }) {
