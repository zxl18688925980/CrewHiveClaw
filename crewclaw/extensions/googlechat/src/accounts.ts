...
import { createAccountListHelpers, type CrewClawConfig } from "openclaw/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: CrewClawConfig): ResolvedGoogleChatAccount[] {
