import type { LineChannelData, CrewClawPluginApi, ReplyPayload } from "openclaw/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: CrewClawPluginApi): void {
  api.registerCommand({
    name: "card",
