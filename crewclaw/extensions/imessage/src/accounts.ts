...
function mergeIMessageAccountConfig(cfg: CrewClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: CrewClawConfig): ResolvedIMessageAccount[] {
