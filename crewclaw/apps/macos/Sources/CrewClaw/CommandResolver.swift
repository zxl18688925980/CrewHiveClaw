...
enum CommandResolver {
    ...
    static func projectCrewClawExecutable(projectRoot: URL? = nil) -> String? {
        #if DEBUG
    ...
    static func hasAnyCrewClawInvoker(searchPaths: [String]? = nil) -> Bool {
        ...
        searchPaths: [String]? = nil) -> [String]
    {
        ...
        let root = self.projectRoot()
        if let openclawPath = self.projectCrewClawExecutable(projectRoot: root) {
    ...
    {
        let root = configRoot ?? CrewClawConfigFile.loadDict()
