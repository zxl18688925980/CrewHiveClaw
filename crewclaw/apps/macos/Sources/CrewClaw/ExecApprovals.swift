...
enum ExecApprovalsStore {
    ...
    static func fileURL() -> URL {
        CrewClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        CrewClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
    ...
    private static func ensureSecureStateDirectory() {
        let url = CrewClawPaths.stateDirURL
        do {
