...
final class LiveActivityManager {
    ...
    private var currentActivity: Activity<CrewClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = CrewClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<CrewClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: CrewClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> CrewClawActivityAttributes.ContentState {
        CrewClawActivityAttributes.ContentState(
    ...
    private func idleState() -> CrewClawActivityAttributes.ContentState {
        CrewClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> CrewClawActivityAttributes.ContentState {
        CrewClawActivityAttributes.ContentState(
