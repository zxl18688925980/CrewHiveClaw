...
export function listAuthProfileStorePaths(config: CrewClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: CrewClawConfig, stateDir: string): string[] {
