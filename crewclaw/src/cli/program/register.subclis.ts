...
export const loadValidatedConfigForPluginRegistration =
  async (): Promise<CrewClawConfig | null> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "lucas",
    description: "Open a terminal UI for Lucas (family AI companion)",
    hasSubcommands: false,
    register: async (program) => {
      const mod = await import("../lucas-tui-cli.js");
      mod.registerLucasTuiCli(program);
    },
  },
  {
    name: "andy",
    description: "Open a terminal UI for Andy (solutions architect)",
    hasSubcommands: false,
    register: async (program) => {
      const mod = await import("../andy-tui-cli.js");
      mod.registerAndyTuiCli(program);
    },
  },
  {
    name: "lisa",
    description: "Open a terminal UI for Lisa (coding expert)",
    hasSubcommands: false,
    register: async (program) => {
      const mod = await import("../lisa-tui-cli.js");
      mod.registerLisaTuiCli(program);
    },
  },
  {
    name: "cron",
  ...
  {
    name: "docs",
    description: "Search the live CrewClaw docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage CrewClaw plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
  ...
  {
    name: "update",
    description: "Update CrewClaw and inspect update channel status",
    hasSubcommands: true,
    register: async (program) => {
