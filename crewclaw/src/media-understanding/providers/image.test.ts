...
const ensureCrewClawModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureCrewClawModelsJson: ensureCrewClawModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureCrewClawModelsJsonMock).toHaveBeenCalled();
