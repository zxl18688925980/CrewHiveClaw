...
import { type CrewClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: CrewClawConfig): string[] {
...
export function listAgentsForGateway(cfg: CrewClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: CrewClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: CrewClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: CrewClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: CrewClawConfig): GatewaySessionsDefaults {
