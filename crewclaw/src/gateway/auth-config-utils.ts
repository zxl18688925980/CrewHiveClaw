import type { GatewayAuthConfig, CrewClawConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: CrewClawConfig, password: string): CrewClawConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
