...
export function listBindings(cfg: CrewClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: CrewClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: CrewClawConfig) {
