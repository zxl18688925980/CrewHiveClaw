...
type WebSearchConfig = NonNullable<CrewClawConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: CrewClawConfig): WebSearchConfig {
