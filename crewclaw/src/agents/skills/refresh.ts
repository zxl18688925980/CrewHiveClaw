...
function resolveWatchPaths(workspaceDir: string, config?: CrewClawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: CrewClawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: CrewClawConfig }) {
