...
type ModelsConfig = NonNullable<CrewClawConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier CrewClaw docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // CrewClaw keeps auth in auth-profiles and resolves runtime availability from that store.
