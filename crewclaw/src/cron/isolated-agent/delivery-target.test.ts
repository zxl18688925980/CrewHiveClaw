...
function makeCfg(overrides?: Partial<CrewClawConfig>): CrewClawConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
function makeTelegramBoundCfg(accountId = "account-b"): CrewClawConfig {
  return makeCfg({
    bindings: [
      {
        agentId: AGENT_ID,
...
async function resolveLastTarget(cfg: CrewClawConfig) {
