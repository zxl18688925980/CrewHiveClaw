...
export function collectMissingDefaultAccountBindingWarnings(cfg: CrewClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: CrewClawConfig): string[] {
  const warnings: string[] = [];
...
function scanTelegramAllowFromUsernameEntries(cfg: CrewClawConfig): TelegramAllowFromUsernameHit[] {
...
async function maybeRepairTelegramAllowFromUsernames(cfg: CrewClawConfig): Promise<{
...
function scanDiscordNumericIdEntries(cfg: CrewClawConfig): DiscordNumericIdHit[] {
...
function maybeRepairDiscordNumericIds(cfg: CrewClawConfig): {
  config: CrewClawConfig;
  changes: string[];
} {
...
function scanMutableAllowlistEntries(cfg: CrewClawConfig): MutableAllowlistHit[] {
 ...
 */
function maybeRepairOpenPolicyAllowFrom(cfg: CrewClawConfig): {
  config: CrewClawConfig;
  changes: string[];
} {
...
async function maybeRepairAllowlistPolicyAllowFrom(cfg: CrewClawConfig): Promise<{
  config: CrewClawConfig;
  changes: string[];
}> {
  const channels = cfg.channels;
 ...
 * file support.
 */
function detectEmptyAllowlistPolicy(cfg: CrewClawConfig): string[] {
  const channels = cfg.channels;
  if (!channels || typeof channels !== "object") {
    return [];
  }
...
function collectExecSafeBinScopes(cfg: CrewClawConfig): ExecSafeBinScopeRef[] {
...
function scanExecSafeBinCoverage(cfg: CrewClawConfig): ExecSafeBinCoverageHit[] {
...
function scanExecSafeBinTrustedDirHints(cfg: CrewClawConfig): ExecSafeBinTrustedDirHintHit[] {
...
function maybeRepairExecSafeBinProfiles(cfg: CrewClawConfig): {
  config: CrewClawConfig;
  changes: string[];
  warnings: string[];
} {
...
function scanLegacyToolsBySenderKeys(cfg: CrewClawConfig): LegacyToolsBySenderKeyHit[] {
  const hits: LegacyToolsBySenderKeyHit[] = [];
  collectLegacyToolsBySenderKeyHits(cfg, [], hits);
  return hits;
}

function maybeRepairLegacyToolsBySenderKeys(cfg: CrewClawConfig): {
  config: CrewClawConfig;
  changes: string[];
} {
  const next = structuredClone(cfg);
...
export async function loadAndMaybeMigrateDoctorConfig(params: {
  ...
  let cfg: CrewClawConfig = baseCfg;
