...
export async function statusCommand(
  ...
  const daemonValue = (() => {
    ...
    const installedPrefix = daemon.managedByCrewClaw ? "installed · " : "";
  ...
  const nodeDaemonValue = (() => {
    ...
    const installedPrefix = nodeDaemon.managedByCrewClaw ? "installed · " : "";
  ...
  runtime.log(theme.heading("CrewClaw status"));
  runtime.log("");
