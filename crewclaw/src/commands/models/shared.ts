...
export async function loadValidConfigOrThrow(): Promise<CrewClawConfig> {
...
export async function updateConfig(
  mutator: (cfg: CrewClawConfig) => CrewClawConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: CrewClawConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: CrewClawConfig): Set<string> {
