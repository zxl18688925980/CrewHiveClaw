...
export function applyProviderDefaultModel(cfg: CrewClawConfig, modelRef: string): CrewClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: CrewClawConfig; modelId: string; modelRef: string; profileId: string } {
