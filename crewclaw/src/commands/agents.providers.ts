...
function resolveDefaultAccountId(cfg: CrewClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CrewClawConfig): boolean {
...
export function summarizeBindings(cfg: CrewClawConfig, bindings: AgentBinding[]): string[] {
