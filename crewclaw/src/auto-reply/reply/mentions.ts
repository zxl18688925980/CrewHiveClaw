...
function resolveMentionPatterns(cfg: CrewClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: CrewClawConfig | undefined, agentId?: string): RegExp[] {
