...
export type CrewClawPluginConfigSchema = {
...
export type CrewClawPluginToolContext = {
...
export type CrewClawPluginToolFactory = (
  ctx: CrewClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type CrewClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type CrewClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type CrewClawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current CrewClaw configuration */
  config: CrewClawConfig;
 ...
 */
export type CrewClawPluginCommandDefinition = {
...
export type CrewClawPluginHttpRouteAuth = "gateway" | "plugin";
export type CrewClawPluginHttpRouteMatch = "exact" | "prefix";

export type CrewClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type CrewClawPluginHttpRouteParams = {
  path: string;
  handler: CrewClawPluginHttpRouteHandler;
  auth: CrewClawPluginHttpRouteAuth;
  match?: CrewClawPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type CrewClawPluginCliContext = {
  program: Command;
  config: CrewClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type CrewClawPluginCliRegistrar = (ctx: CrewClawPluginCliContext) => void | Promise<void>;

export type CrewClawPluginServiceContext = {
  config: CrewClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type CrewClawPluginService = {
  id: string;
  start: (ctx: CrewClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: CrewClawPluginServiceContext) => void | Promise<void>;
};

export type CrewClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type CrewClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: CrewClawPluginConfigSchema;
  register?: (api: CrewClawPluginApi) => void | Promise<void>;
  activate?: (api: CrewClawPluginApi) => void | Promise<void>;
};

export type CrewClawPluginModule =
  | CrewClawPluginDefinition
  | ((api: CrewClawPluginApi) => void | Promise<void>);

export type CrewClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | CrewClawPluginToolFactory,
    opts?: CrewClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: CrewClawPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: CrewClawPluginHttpRouteParams) => void;
  registerChannel: (registration: CrewClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: CrewClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: CrewClawPluginService) => void;
   ...
   */
  registerCommand: (command: CrewClawPluginCommandDefinition) => void;
