...
const discoverCrewClawPluginsMock = vi.fn();
const loadPluginManifestMock = vi.fn();

vi.mock("./discovery.js", () => ({
  discoverCrewClawPlugins: (...args: unknown[]) => discoverCrewClawPluginsMock(...args),
}));
...
describe("bundled plugin sources", () => {
  beforeEach(() => {
    discoverCrewClawPluginsMock.mockReset();
    loadPluginManifestMock.mockReset();
  });

  it("resolves bundled sources keyed by plugin id", () => {
    discoverCrewClawPluginsMock.mockReturnValue({
      candidates: [
        {
          origin: "global",
  ...
  it("forwards an explicit env to bundled discovery helpers", () => {
    ...
    expect(discoverCrewClawPluginsMock).toHaveBeenNthCalledWith(1, {
      workspaceDir: "/workspace",
      env,
    });
    expect(discoverCrewClawPluginsMock).toHaveBeenNthCalledWith(2, {
      workspaceDir: "/workspace",
      env,
    });
  });
