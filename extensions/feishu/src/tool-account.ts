...
import type { CrewClawPluginApi } from "openclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: CrewClawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<CrewClawPluginApi, "config">;
