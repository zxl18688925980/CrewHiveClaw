...
export function listWhatsAppAuthDirs(cfg: CrewClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CrewClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CrewClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CrewClawConfig): ResolvedWhatsAppAccount[] {
