...
// Prefix for CrewClaw-generated action IDs to scope our handler
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Block Kit button clicks from CrewClaw-generated messages
  ...
  // Handle CrewClaw modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
