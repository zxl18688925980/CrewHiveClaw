...
function mergeSignalAccountConfig(cfg: CrewClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: CrewClawConfig): ResolvedSignalAccount[] {
