...
import type { CrewClawPluginApi } from "openclaw/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("openclaw/plugin-sdk/mattermost").CrewClawConfig;
 ...
 */
export function registerSlashCommandRoute(api: CrewClawPluginApi) {
