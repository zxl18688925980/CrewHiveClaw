...
const lineConfigBase = createScopedChannelConfigBase<ResolvedLineAccount, CrewClawConfig>({
  sectionKey: "line",
...
export const linePlugin: ChannelPlugin<ResolvedLineAccount> = {
  ...
  pairing: {
    ...
    notifyApproval: async ({ cfg, id }) => {
      ...
      await line.pushMessageLine(id, "CrewClaw: your access has been approved.", {
  ...
  gateway: {
    ...
    logoutAccount: async ({ accountId, cfg }) => {
      ...
      const nextCfg = { ...cfg } as CrewClawConfig;
      const lineConfig = (cfg.channels?.line ?? {}) as LineConfig;
