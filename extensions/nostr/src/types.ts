...
import type { CrewClawConfig } from "openclaw/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: CrewClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: CrewClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: CrewClawConfig): string {
