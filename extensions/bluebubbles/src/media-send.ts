...
import { resolveChannelMediaMaxBytes, type CrewClawConfig } from "openclaw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: CrewClawConfig; accountId?: string }): string[] {
