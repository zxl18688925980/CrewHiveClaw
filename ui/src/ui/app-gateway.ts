...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as CrewClawApp);
      void loadAgents(host as unknown as CrewClawApp);
      void loadHealthState(host as unknown as CrewClawApp);
      void loadNodes(host as unknown as CrewClawApp, { quiet: true });
      void loadDevices(host as unknown as CrewClawApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as CrewClawApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as CrewClawApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as CrewClawApp, payload);
