...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    if (!loaded) {
      ({ resolveCrewClawPackageRoot } = await import("./openclaw-root.js"));
    ...
    vi.mocked(resolveCrewClawPackageRoot).mockClear();
  ...
  function mockPackageInstallStatus() {
    vi.mocked(resolveCrewClawPackageRoot).mockResolvedValue("/opt/openclaw");
