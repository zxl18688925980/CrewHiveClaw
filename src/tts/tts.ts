...
export function resolveTtsConfig(cfg: CrewClawConfig): ResolvedTtsConfig {
...
export function buildTtsSystemPromptHint(cfg: CrewClawConfig): string | undefined {
  ...
  for (const provider of providers) {
    ...
    try {
      if (provider === "edge") {
        ...
        const tempRoot = resolvePreferredCrewClawTmpDir();
