...
export async function finalizeOnboardingWizard(
    ...
    if (hatchChoice === "tui") {
      ...
      await prompter.note(
        [
          ...
          controlUiOpened
            ? "Opened in your browser. Keep that tab to control CrewClaw."
            : "Copy/paste this URL in a browser on this machine to control CrewClaw.",
          controlUiOpenHint,
        ]
          .filter(Boolean)
          .join("\n"),
  ...
  await prompter.outro(
    controlUiOpened
      ? "Onboarding complete. Dashboard opened; keep that tab to control CrewClaw."
      : seededInBackground
        ? "Onboarding complete. Web UI seeded in the background; open it anytime with the dashboard link above."
        : "Onboarding complete. Use the dashboard link above to control CrewClaw.",
  );
