import type { BrowserConfig, BrowserProfileConfig, CrewClawConfig } from "../config/config.js";
 ...
 *
 * Note: this is an CrewClaw browser profile (routing config), not a Chrome user profile.
