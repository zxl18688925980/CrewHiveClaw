...
function resolveAnthropicDefaultAuthMode(cfg: CrewClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyTalkApiKey(config: CrewClawConfig): CrewClawConfig {
...
export function applyTalkConfigNormalization(config: CrewClawConfig): CrewClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: CrewClawConfig): CrewClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyLoggingDefaults(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyContextPruningDefaults(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyCompactionDefaults(cfg: CrewClawConfig): CrewClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
