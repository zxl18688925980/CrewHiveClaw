...
function collectConfigEnvVarsByTarget(cfg?: CrewClawConfig): Record<string, string> {
...
export function collectConfigRuntimeEnvVars(cfg?: CrewClawConfig): Record<string, string> {
  return collectConfigEnvVarsByTarget(cfg);
}

export function collectConfigServiceEnvVars(cfg?: CrewClawConfig): Record<string, string> {
  return collectConfigEnvVarsByTarget(cfg);
}

/** @deprecated Use `collectConfigRuntimeEnvVars` or `collectConfigServiceEnvVars`. */
export function collectConfigEnvVars(cfg?: CrewClawConfig): Record<string, string> {
