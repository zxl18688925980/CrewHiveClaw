...
export type AgentRuntimeDaemonConfig = {
  /** HTTP base URL of the local CrewClaw daemon (e.g. "http://localhost:3000"). */
  url: string;
  /** Optional endpoint path for chat. Defaults to /api/chat. */
  path?: string;
};
...
export type AgentRuntimeConfig =
  ...
  | {
      // CrewClaw: proxy agent requests to a local daemon HTTP endpoint.
      type: "daemon";
      daemon: AgentRuntimeDaemonConfig;
    };
