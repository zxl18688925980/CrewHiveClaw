...
export function resolveSubagentToolPolicy(cfg?: CrewClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: CrewClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: CrewClawConfig["tools"];
