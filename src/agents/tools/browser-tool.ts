...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    name: "browser",
    description: [
      "Control the browser via CrewClaw's browser control server (status/start/stop/profiles/tabs/open/snapshot/screenshot/actions).",
      "Browser choice: omit profile by default for the isolated CrewClaw-managed browser (`openclaw`).",
      ...
      'User-browser flows need user interaction: profile="user" may require approving a browser attach prompt; profile="chrome-relay" needs the user to click the CrewClaw Browser Relay toolbar icon on the tab (badge ON). If user presence is unclear, ask first.',
