...
function resolveMemoryToolContext(options: { config?: CrewClawConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: CrewClawConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: CrewClawConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: CrewClawConfig): MemoryCitationsMode {
