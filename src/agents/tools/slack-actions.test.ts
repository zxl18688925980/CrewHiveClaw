...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): CrewClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: CrewClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: CrewClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
