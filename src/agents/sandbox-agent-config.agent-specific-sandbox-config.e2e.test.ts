...
async function resolveContext(config: CrewClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): CrewClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
