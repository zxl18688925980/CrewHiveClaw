...
import { resolveCrewClawMetadata, resolveSkillInvocationPolicy } from "./frontmatter.js";
...
describe("resolveCrewClawMetadata install validation", () => {
  function resolveInstall(frontmatter: Record<string, string>) {
    return resolveCrewClawMetadata(frontmatter)?.install;
  }
