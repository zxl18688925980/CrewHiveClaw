...
function makeFallbacksOnlyCfg(): CrewClawConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): CrewClawConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
...
// Internal CrewClaw compatibility marker, not a provider API contract.
