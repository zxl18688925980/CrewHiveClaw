...
type AgentEntry = NonNullable<NonNullable<CrewClawConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: CrewClawConfig): AgentEntry[] {
...
export function listAgentIds(cfg: CrewClawConfig): string[] {
...
export function resolveDefaultAgentId(cfg: CrewClawConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: CrewClawConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: CrewClawConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: CrewClawConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: CrewClawConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
