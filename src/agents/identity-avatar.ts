...
function resolveAvatarSource(cfg: CrewClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: CrewClawConfig, agentId: string): AgentAvatarResolution {
