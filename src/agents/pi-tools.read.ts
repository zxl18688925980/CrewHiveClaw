...
function resolveAdaptiveReadMaxBytes(options?: CrewClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createCrewClawReadTool(base, {
...
export function createCrewClawReadTool(
  base: AnyAgentTool,
  options?: CrewClawReadToolOptions,
): AnyAgentTool {
