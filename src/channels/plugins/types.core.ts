...
export type ChannelAgentToolFactory = (params: { cfg?: CrewClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: CrewClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: CrewClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: CrewClawConfig }) => boolean;
  supportsCards?: (params: { cfg: CrewClawConfig }) => boolean;
