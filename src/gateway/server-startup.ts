...
import type { loadCrewClawPlugins } from "../plugins/loader.js";
...
export async function startGatewaySidecars(params: {
  ...
  pluginRegistry: ReturnType<typeof loadCrewClawPlugins>;
  ...
  // Start CrewClaw browser control server (unless disabled via config).
