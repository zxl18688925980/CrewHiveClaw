...
export function hasAmbiguousGatewayAuthModeConfig(cfg: CrewClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: CrewClawConfig): void {
