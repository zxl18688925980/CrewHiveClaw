...
export function resolveHooksConfig(cfg: CrewClawConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: CrewClawConfig, defaultAgentId: string): Set<string> {
