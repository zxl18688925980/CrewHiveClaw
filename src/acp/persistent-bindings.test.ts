...
type ConfiguredBinding = NonNullable<CrewClawConfig["bindings"]>[number];
...
function createCfgWithBindings(
  ...
  overrides?: Partial<CrewClawConfig>,
): CrewClawConfig {
  return {
    ...baseCfg,
    ...overrides,
...
function resolveBindingRecord(cfg: CrewClawConfig, overrides: Partial<BindingRecordInput> = {}) {
