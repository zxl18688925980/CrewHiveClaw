...
const SAFE_DAEMON_ENV_KEYS = [
  "CREWCLAW_PROFILE",
  "CREWCLAW_STATE_DIR",
  "CREWCLAW_CONFIG_PATH",
  "CREWCLAW_GATEWAY_PORT",
  "CREWCLAW_NIX_MODE",
  // Legacy CrewClaw compat
  "OPENCLAW_PROFILE",
  "OPENCLAW_STATE_DIR",
    ...
    hints.push(
      ...buildPlatformRuntimeLogHints({
        ...
        systemdServiceName: resolveGatewaySystemdServiceName(
          env.CREWCLAW_PROFILE ?? env.OPENCLAW_PROFILE,
        ),
        windowsTaskName: resolveGatewayWindowsTaskName(
          env.CREWCLAW_PROFILE ?? env.OPENCLAW_PROFILE,
        ),
      }),
    );
...
export function renderGatewayServiceStartHints(env: NodeJS.ProcessEnv = process.env): string[] {
  ...
  return buildPlatformServiceStartHints({
    installCommand: formatCliCommand("crewclaw gateway install", env),
    startCommand: formatCliCommand("crewclaw gateway", env),
