...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CrewClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CrewClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: CrewClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
