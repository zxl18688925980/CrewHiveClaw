...
import type { CrewClawConfig, ConfigFileSnapshot } from "../config/config.js";
  ...
  for (const pluginName of pluginDirs) {
    ...
    if (summary.critical > 0) {
      ...
      findings.push({
        ...
        remediation:
          "Review the plugin source code carefully before use. If untrusted, remove the plugin from your CrewClaw extensions state directory.",
      });
