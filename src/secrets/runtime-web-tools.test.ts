...
async function runRuntimeWebTools(params: { config: CrewClawConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: CrewClawConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
