...
export function applyVercelAiGatewayProviderConfig(cfg: CrewClawConfig): CrewClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: CrewClawConfig): CrewClawConfig {
