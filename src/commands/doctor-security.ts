...
import type { CrewClawConfig, GatewayBindMode } from "../config/config.js";
...
function collectImplicitHeartbeatDirectPolicyWarnings(cfg: CrewClawConfig): string[] {
...
export async function noteSecurityWarnings(cfg: CrewClawConfig) {
  const warnings: string[] = [];
