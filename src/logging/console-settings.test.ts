...
let originalCrewClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalCrewClawTestConsole = process.env.OPENCLAW_TEST_CONSOLE;
...
afterEach(() => {
  ...
  if (originalCrewClawTestConsole === undefined) {
    delete process.env.OPENCLAW_TEST_CONSOLE;
  } else {
    process.env.OPENCLAW_TEST_CONSOLE = originalCrewClawTestConsole;
  }
