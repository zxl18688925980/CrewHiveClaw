...
PENDING_FILE="$HOMEAI_DIR/data/finetune/pending-samples.jsonl"
DATA_SPLIT_DIR="$HOMEAI_DIR/data/finetune/incremental-split"
LOG_FILE="$HOMEAI_DIR/logs/finetune.log"
