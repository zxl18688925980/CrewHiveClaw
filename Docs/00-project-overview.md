...
> HiveClaw 是 CrewClaw 的云端侧——各实例上传去标识化语料，云端三模型各自增训，蒸馏后反哺新实例冷启动。哲学层设计见 Part 2 七、八节。
>
> 详细实现见 **`07-advanced-version.md`**（HomeAI 云端实例实现与验证）。
>
> HomeAI 本地实例实现见 **`06-basic-version.md`**。
