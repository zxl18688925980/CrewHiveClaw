...
| **L2** | 系统自进化  | 自身能力越来越强 | 三个诉求：**开发流水线成效**（Andy spec 质量 + Lisa 成功率 + opencode 吻合率）+ **自进化机制运转**（蒸馏/结晶/同类错误减少）+ **喂养成效**（外部知识注入→设计判断的转化率）                                                                                                               | 成熟行为模式能被识别并自动固化；Andy 能自主判断固化形式；角色间知识共享机制正常运转                      |
...
L2 = 系统自进化·自身能力越来越强：开发流水线成效 + 自进化机制运转 + 喂养成效
